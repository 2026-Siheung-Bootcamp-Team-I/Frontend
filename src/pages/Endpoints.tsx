  ...
  return (
    <div className="flex flex-col gap-[20px]">
      ...
      <Card className="px-[16px] py-[18px] sm:px-[24px] sm:py-[22px]">
        ...
        {/*
          상태와 위험도는 기준이 달라 한 줄에서 어긋나 보인다. 보통 알림이 수십 건이면
          상태는 정상인데 위험도만 100 이 된다. 임계값을 지어내는 대신 차이를 밝힌다.
        */}
        <div className="mt-[16px] text-[12px] leading-[1.5] text-faint">
          상태는 가장 높은 심각도 하나로, 위험도는 열린 알림을 모두 더해 정해집니다. 낮은 심각도가
          많이 쌓이면 상태가 정상이어도 위험도는 높게 나옵니다.
        </div>
      </Card>
    </div>
  )
